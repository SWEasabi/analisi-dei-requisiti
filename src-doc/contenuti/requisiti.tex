...
\begin{center}
    \begin{xltabular}{\linewidth}{|l|l|X|l|}
        ...
        \hline
        RF\_8 & Obbligatorio & L'utente deve poter inserire la locazione geografica del sensore nel sistema & Capitolato, UC10\\

        \hline
        RF\_9 & Obbligatorio & L'utente deve poter inserire il raggio d'azione del sensore nel sistema & Capitolato, UC\\ %manca uc?%
        ...
        \hline
        RF\_16 & Obbligatorio & L'utente deve essere in grado di segnalare manualmente guasti nei lampioni & Capitolato, UC6 \\

        \hline
        RF\_17 & Opzionale & Il gestore deve poter visualizzare l'elenco degli impianti guasti & Capitolato, UC07 \\

        \hline
        RF\_18 & Obbligatorio & L'utente manutentore deve essere in grado di chiudere le segnalazioni di guasto dalla lista guasti & Capitolato, UC9 \\

        \hline
        RF\_19 & Opzionale & Il sistema deve essere in grado di regolare automaticamente l'intensità luminosa dei lampioni in caso rilevi valori fuori soglia di luminosità ambientale & Capitolato\\

        \hline
        RF\_20 & Obbligatorio & Il sistema deve essere in grado di ricevere informazioni dal sensore in modalità Push & Capitolato \\

        \hline
        RF\_21 & Opzionale & Il sistema deve essere in grado di ricevere informazioni dal sensore in modalità Pull & Capitolato \\
